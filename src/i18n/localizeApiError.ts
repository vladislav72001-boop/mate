...
const EXACT: Record<string, string> = {
  ...
  'Ссылка восстановления недействительна или устарела': 'errors.resetInvalid',
  'Пароль должен быть не короче 8 символов': 'errors.passwordTooShort',
  'Пароль не короче 8 символов': 'errors.passwordTooShort',
  'Укажите текущий пароль': 'errors.currentPasswordRequired',
  'Неверный текущий пароль': 'errors.wrongCurrentPassword',
  'Введите корректный email': 'errors.invalidEmail',
  'Не удалось отправить письмо. Попробуйте позже': 'errors.resetMailFail',
  'Не удалось отправить письмо восстановления': 'errors.resetMailFail',
  'Не удалось обновить пароль': 'errors.resetFail',
